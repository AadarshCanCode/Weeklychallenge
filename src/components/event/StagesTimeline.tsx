      ...
      <div className="relative py-5">
        ...
        <div className="flex items-start mb-15 relative">
          ...
          <div className="px-4 md:px-6 flex-1">
            <h3 className="text-lg font-semibold text-foreground">Stage 0: Registration</h3>
            <div className="flex flex-wrap gap-4 text-sm text-muted-foreground my-1">
              <span>20th, 21st Oct</span>
              <span>• 2 days</span>
            </div>
            <div className="text-foreground/80 text-sm leading-relaxed">
              Register to participate in the DSA Sprint competition.
            </div>
            <p className="flex items-center gap-1.5 cursor-pointer w-fit text-primary hover:underline font-semibold mt-3">
